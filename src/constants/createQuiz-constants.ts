  ...
  <button class="remove-card absolute -top-3 -right-3">
              ...
              <div class="choices-section flexbox-column gap-y-2">
                ...
                <div class="choice flex items-center gap-x-2">
                  <input
                    type="radio"
                    name="correct-${counter}"
                    id="correct-${counter}-2"
                    value="2"
                    class="accent-purple-600"
                  />
                  <input
                    type="text"
                    name="choice-${counter}-2"
                    id="choice-${counter}-2"
                    maxlength="60"
                ...
                <div class="choice flex items-center gap-x-2">
                  <input
                    type="radio"
                    name="correct-${counter}"
                    id="correct-${counter}-3"
                    value="3"
                    class="accent-purple-600"
                  />
                  <input
                    type="text"
                    name="choice-${counter}-3"
                    id="choice-${counter}-3"
                    maxlength="60"
                ...
                <div class="choice flex items-center gap-x-2">
                  <input
                    type="radio"
                    name="correct-${counter}"
                    id="correct-${counter}-4"
                    value="4"
                    class="accent-purple-600"
                  />
                  <input
                    type="text"
                    name="choice-${counter}-4"
                    id="choice-${counter}-4"
                    maxlength="60"
              ...
              <div class="open-ended-section flexbox-column gap-y-2 hidden">
                ...
                <input
                  ...
                  class="open-answer input border border-purple-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400"
                />
              </div>
            </div>
`;
