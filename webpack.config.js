...
module.exports = (env) => {
  ...
  return {
    ...
    entry: {
      ...
      soonTS: path.resolve(__dirname, "src", "features", "soon.ts"),
    },
    output: {
      ...
      new CopyPlugin({
        patterns: [
          ...
          },
          {
            ...
            to: path.resolve(__dirname, "dist", "assets", "create.png"),
            noErrorOnMissing: true,
          },
          {
            from: path.resolve(
            ...
            to: path.resolve(__dirname, "dist", "assets", "solve.png"),
            noErrorOnMissing: true,
          },
        ],
      }),
